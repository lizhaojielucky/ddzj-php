...
class TransactionSettingsLogic extends BaseLogic
{
    ...
    public static function getConfig()
    {
        $config = [
            ...
            'is_auth_dispatch' => ConfigService::get('transaction', 'is_auth_dispatch',0),
            'verification_services_distance' => ConfigService::get('transaction', 'verification_services_distance',100),
        ];
    ...
    public static function setConfig($params)
    {
        ...
        if(isset($params['verification_services_distance'])) {
            ConfigService::set('transaction', 'verification_services_distance', $params['verification_services_distance']);
        }
    }
}