...
class TransactionSettingsValidate extends BaseValidate
{
    protected $rule = [
        ...
        'verification_services_distance' => 'require|integer|gt:0',
    ];
    ...
    protected $message = [
        ...
        'verification_services_distance.require' => '请输入核销服务距离',
        'verification_services_distance.integer' => '核销服务距离须为整型',
        'verification_services_distance.gt' => '核销服务距离须大于0',
    ];
    ...
    public function sceneSetConfig()
    {
        return $this->only([
            ...
            'is_auth_dispatch',
            'verification_services_distance'
        ]);
    }
}